                ...
                <Dialog.Panel className="pointer-events-auto relative w-screen max-w-6xl">
                  ...
                  >
                    <div className="absolute left-0 top-0 -ml-8 flex pr-2 pt-4 sm:-ml-10 sm:pr-4">
                      <button
                        type="button"
                        className="relative rounded-md text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white bg-transparent"
                        onClick={onClose}
                      >
...
SlideOver.Content = function SlideOverContent({ children }: PropsWithChildren) {
